        ...
        <div className="about-container">
          ...
          <div className="about-points">
            <ul>
              ...
              <li>Giving them the experience of the sweetness of a relationship by giving them love like a family.</li>
        ...
        <div className="who-container">
          <div className="who-text">
            <p>
              ...
              Born in a typical Maharashtrian rural Warkari family...
            </p>
      ...
      <section className="needs-section">
        ...
        <div className="needs-container">
          <div className="needs-points">
            <ul>
              <li>• Education for all ages...</li>
              <li>• To inculcate civilization...</li>
              <li>• Health awareness and medical aid...</li>
